...
export default function HeroBanner({ onShopClick }) {
  return (
    <section id="top" className="relative overflow-hidden bg-cream">
      <div className="pointer-events-none absolute -left-24 -top-24 h-72 w-72 rounded-full bg-sunny-200/60 blur-3xl" />
      <div className="pointer-events-none absolute -right-16 top-10 h-80 w-80 rounded-full bg-teal-200/50 blur-3xl" />
      <div className="pointer-events-none absolute bottom-0 left-1/3 h-64 w-64 rounded-full bg-berry-200/40 blur-3xl" />
      ...
      <div className="relative mx-auto grid max-w-7xl gap-10 px-4 py-12 sm:px-6 md:grid-cols-2 md:items-center md:py-20 lg:px-8">
        <div className="text-center md:text-left">
          <span className="inline-flex items-center gap-2 rounded-full bg-teal-100 px-4 py-1.5 text-xs font-extrabold uppercase tracking-widest text-teal-700">
            Summer '26 Drop
          </span>
          ...
          <h1 className="mt-5 font-display text-4xl font-extrabold leading-[1.05] tracking-tight text-ink sm:text-5xl lg:text-6xl">
            ...
            <span className="bg-gradient-to-r from-coral-500 via-berry-500 to-teal-500 bg-clip-text text-transparent">
              everyday adventures
            </span>
          </h1>
          ...
          <div className="mt-8 flex flex-col items-center gap-4 sm:flex-row sm:justify-center md:justify-start">
            ...
            <div className="flex items-center gap-1.5 text-sm font-semibold text-ink/70">
              <div className="flex text-sunny-500">
        ...
        <div className="relative mx-auto w-full max-w-md md:max-w-none">
          <div className="relative aspect-square w-full overflow-hidden rounded-[2.5rem] border-4 border-white bg-gradient-to-br from-coral-300 via-sunny-300 to-teal-300 shadow-2xl shadow-coral-500/20">
          ...
          <div className="absolute -left-4 top-6 flex items-center gap-2 rounded-2xl bg-white px-4 py-2.5 shadow-xl sm:-left-8">
            <span className="flex h-9 w-9 items-center justify-center rounded-full bg-sunny-100 text-sunny-600">
          ...
          <div className="absolute -bottom-4 right-2 flex items-center gap-2 rounded-2xl bg-white px-4 py-2.5 shadow-xl sm:-right-6">
            <span className="flex h-9 w-9 items-center justify-center rounded-full bg-teal-100 text-teal-600">
